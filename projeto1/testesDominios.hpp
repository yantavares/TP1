...
// Classe feita por Mateus Gomes de Araujo 20201440
class TUNome {
private:
...
/// @brief Declaracao de classe de teste de unidade do domínio Titulo
// Classe feita por Mateus Gomes de Araujo 20201440
class TUTitulo{
private:
    /// Definições de constantes para evitar números mágicos.
...
/// @brief Declaracao de classe de teste de unidade do domínio Duracao
// Classe feita por Mateus Gomes de Araujo 20201440
class TUDuracao{
private:
    /// Definições de constantes para evitar números mágicos.
...
/// @brief Declaracao de classe de teste do unidade do domínio Endereco
// Classe feita por Mateus Gomes de Araujo 20201440
class TUEndereco{
private:
    /// Definições de constantes para evitar números mágicos.
...
/// @brief Declaracao de classe de teste de unidade do domínio Horario
// Classe feita por Mateus Gomes de Araujo 20201440
class TUHorario{
private:
    /// Definições de constantes para evitar números mágicos.
